define([
  ...
  class getAccountstatuslovFetch extends ActionChain {
    ...
    async run(context, { configuration }) {
      ...
      if (configuration.hookHandler.context.fetchOptions.filterCriterion) {
        if (configuration.hookHandler.context.fetchOptions.filterCriterion.text.length >= 1) {
          const response = await Actions.callRest(context, {
            ...
            uriParams: {
              ...
              'p_current_status': $variables.accountCurrent.lineStatus,
            },
          });
        ...
        const currentStatus = $variables.accountCurrent.lineStatus;
  ...
  return getAccountstatuslovFetch;
});
